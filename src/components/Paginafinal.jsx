  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center w-full">
        <h1 className="text-center text-6xl font-serif py-16">Contact</h1>
              ...
              <div className="space-y-2 w-5/6 mx-auto">
                <div className="lg:text-left">
                  ...
                  <p className="text-lg w-full mx-auto">
                    ...
                    to collaborate on new projects and opportunities. Whether
                    you have an interesting idea or need assistance bringing
                    your visions to life, I'm here to help. Let's work together
